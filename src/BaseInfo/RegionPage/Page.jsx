...
import { List, Delete } from '../../_actions/baseInfo/region'
      ...
      <div className={styles.container}>
        ...
        <Paper className={styles.table}>
          <Table TableCellHeaders={
            ...
            <CustomTableCell align="center" key="1">نام به انگلیسی</CustomTableCell>,
            <CustomTableCell align="center" key="2">نام به فارسی</CustomTableCell>,
            <CustomTableCell align="center" key="3">پیش شماره استان</CustomTableCell>,
            ...
            rows={list.map((row, index) => (
              <TableRow className={styles.row} key={row.regionId}>
                <CustomTableCell align="left" component="th" scope="row">
                  {index + 1 + page * rowsPerPage}
                </CustomTableCell>
                <CustomTableCell align="center">{row.englishName}</CustomTableCell>
                <CustomTableCell align="center">{row.persianName}</CustomTableCell>
                <CustomTableCell align="center">{row.prePhone}</CustomTableCell>
                <ActionTableCell align="center">
                  <Link to={"/region/" + row.regionId} className={styles.link}>
                ...
                <ActionTableCell align="center">
                  <Fab size="small" color="secondary" onClick={() => { alert('You clicked delete ') }} aria-label="Delete" className={styles.margin}>
