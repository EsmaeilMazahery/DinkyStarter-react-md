...
import { SAVE_PERIOD } from '../_constants/editor';
import { save, clear as clearEditor, updateStory } from '../_actions/editor';
import { clear as clearYourStories } from '../_actions/your-stories'
import { receiveStory } from '../_actions/story'
import { receiveStories } from '../_actions/stories'
import { selectTab } from '../_actions/your-stories';
import { callWith401Handle } from './api'
import { get } from '../_utils/api'
import { STORY_DETAIL, STORIES, NOTIFICATIONS } from '../_constants/api';
import { removeStateReceivedFrom } from '../_actions/cache';
import * as signalR from '@aspnet/signalr'

import { COMPANYINFO } from '../_constants/api'
...
export function* getCompanyInfo(){
  const companyInfo = yield call(get, COMPANYINFO)
  yield put(receiveCompanyInfo(companyInfo))
}
